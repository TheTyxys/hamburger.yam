...
function library:saveConfig()
    ...
    writefile("hamburger/"..tostring(game.GameId).."/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("hamburger/"..tostring(game.GameId).."/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("hamburger/"..tostring(game.GameId).."/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("hamburger/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("hamburger/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("hamburger/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
